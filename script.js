(() => {
    ...
    function c(e) {
        ...
        t.innerHTML = "", n.innerHTML = ""; for (const c of e) {
            const e = document.createElement("article");
            e.classList.add("book_item");
            const a = document.createElement("h2");
            a.innerText = c.title; const u = document.createElement("p"); u.innerText = "Penulis: " + c.author;
            const r = document.createElement("p");
            if (r.innerText = "Tahun: " + c.year, e.appendChild(a), e.appendChild(u), e.appendChild(r), c.isComplete) {
                const t = document.createElement("div");
                t.classList.add("action"); const o = document.createElement("button");
                o.id = c.id, o.innerText = "Belum Selesai dibaca", o.classList.add("green"),
                    o.addEventListener("click", d);
                const a = document.createElement("button");
                a.id = c.id, a.innerText = "Hapus buku", a.classList.add("red"),
                    a.addEventListener("click", i), t.appendChild(o), t.appendChild(a),
                ...
                a.id = c.id, a.innerText = "Hapus buku",
                    a.classList.add("red"), a.addEventListener("click", i),
...
function search() {
    const cari = document.querySelector("#searchBook");
    cari.alert("Masukan nama buku yang benar")
}